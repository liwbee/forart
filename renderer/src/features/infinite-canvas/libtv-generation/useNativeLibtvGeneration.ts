...
import { nativeResultsFromTask } from "../generation/generationResultDownloadState";
...
export function useNativeLibtvGeneration({
  ...
  const stopLibtvGeneration = useCallback(async (nodeId: string, taskIdOverride?: string) => {
