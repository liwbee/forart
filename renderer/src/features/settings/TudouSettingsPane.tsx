...
import type { ApiPanelStatus } from "./ApimartSettingsPane";
...
export function TudouSettingsPane({ provider, fetchingModels, status, onProviderChange, onFetchModels, onRemove }: TudouSettingsPaneProps) {
      ...
      <section className="settings-api-block">
        ...
        <div className="settings-api-form">
          ...
          <label className="settings-field">
            ...
            <div className="settings-fixed-provider-api-key-row">
              ...
              <Button type="button" className="settings-api-control-button" disabled={fetchingModels} onClick={onFetchModels}>
