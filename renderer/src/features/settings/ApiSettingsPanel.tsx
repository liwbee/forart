              ...
              <section className="settings-api-block">
                ...
                <div className="settings-api-form">
                  ...
                  <div className="settings-api-key-row">
                    <label className="settings-field"><span>{t("settings:apiKey")}</span><input type="password" value={selectedProvider.apiKey} onChange={(event) => patchSelectedProvider({ apiKey: event.target.value })} placeholder={selectedProvider.hasApiKey ? t("settings:apiKeyConfiguredPlaceholder") : t("settings:apiKeyPlaceholder")} /></label>
